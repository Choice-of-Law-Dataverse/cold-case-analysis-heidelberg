...
def classify_choice_of_law_issue(text, classification_prompt, model, concepts):
...
def extract_choice_of_law_issue(text, classification_prompt, prompt, model, concepts):
    classification = classify_choice_of_law_issue(text, classification_prompt, model, concepts)
